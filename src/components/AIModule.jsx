...
const t = {
  fr: {
    ...
    inputBtn: 'Générer avec IA', inputLoading: 'Génération...',
    demoTag: 'Démonstration interactive', demoLabel: "Essayez notre assistant créatif IA",
    chips: ['Branding', 'Campagne LED', 'Véhicule', 'Print'],
    responses: [
      "Analyse complète de votre identité de marque — Je détecte un secteur B2B premium. Recommandation : palette sobre avec accent doré, typographie sans-serif moderne, photographie lifestyle corporate. Slogan proposé : « L'excellence, votre signature. »",
      "Concept visuel généré — Pour votre secteur, je recommande un design minimaliste avec touches de couleur vive. Palette : #F7B500, #1A1A2E, blanc pur. Format prioritaire : carré pour réseaux sociaux + A4 horizontal pour print.",
      "Stratégie de communication — Votre cible : 35–55 ans, décideurs B2B. Canal principal : LinkedIn + impression premium. Message clé : fiabilité, expertise, résultats mesurables. Ton : professionnel mais accessible.",
    ]
  },
  nl: {
    ...
    inputBtn: 'Genereer met AI', inputLoading: 'Genereren...',
    ...
    responses: [
      "Volledige merkidentiteitsanalyse — Ik detecteer een premium B2B-sector. Aanbeveling: sober palet met gouden accent, moderne sans-serif typografie, corporate lifestyle fotografie. Voorgestelde slogan: « Excellentie, uw handtekening. »",
      "Visueel concept gegenereerd — Voor uw sector beveel ik een minimalistisch ontwerp aan met levendige kleuraccenten. Palet: #F7B500, #1A1A2E, puur wit. Prioriteitsformaat: vierkant voor sociale media + A4 horizontaal voor print.",
      "Communicatiestrategie — Uw doelgroep: 35–55 jaar, B2B-beslissers. Hoofdkanaal: LinkedIn + premium print. Kernboodschap: betrouwbaarheid, expertise, meetbare resultaten. Toon: professioneel maar toegankelijk.",
    ]
  },
  en: {
    ...
    inputBtn: 'Generate with AI', inputLoading: 'Generating...',
    demoTag: 'Interactive demo', demoLabel: 'Try our creative AI assistant',
    chips: ['Branding', 'LED Campaign', 'Vehicle', 'Print'],
    responses: [
      "Full brand identity analysis — I detect a premium B2B sector. Recommendation: clean palette with golden accent, modern sans-serif typography, corporate lifestyle photography. Proposed tagline: « Excellence, your signature. »",
      "Visual concept generated — For your sector I recommend a minimalist design with vivid colour accents. Palette: #F7B500, #1A1A2E, pure white. Priority format: square for social media + A4 landscape for print.",
      "Communication strategy — Your target: 35–55 years, B2B decision-makers. Main channel: LinkedIn + premium print. Key message: reliability, expertise, measurable results. Tone: professional yet accessible.",
    ]
  }
}
...
const FeatureIcon = ({ index }) => {
  const icons = [
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" key="0"><circle cx="12" cy="8" r="4"/><path d="M2 20a10 10 0 0 1 20 0"/></svg>,
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" key="1"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>,
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" key="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>,
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" key="3"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>,
  ]
        ...
        >
          ...
          <div className="ai-features">
            {T.features.map((f,i) => (
              ...
              >
                <span className="feature-icon-wrap"><FeatureIcon index={i} /></span>
                <div>
